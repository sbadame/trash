...
var special = map[simpleTime]Pickup{
	// 2026
	{2026, time.January, 1}:    NO_PICKUP_HOLIDAY,
	{2026, time.January, 2}:    TRASH,
	{2026, time.January, 7}:    COMMINGLES,
	{2026, time.January, 14}:   PAPER,
	{2026, time.January, 19}:   NO_PICKUP_HOLIDAY,
	{2026, time.January, 20}:   TRASH,
	{2026, time.January, 21}:   NO_PICKUP,
	{2026, time.January, 22}:   COMMINGLES,
	{2026, time.January, 23}:   TRASH,
	{2026, time.January, 28}:   PAPER,
	{2026, time.February, 4}:   COMMINGLES,
	{2026, time.February, 11}:  PAPER,
	{2026, time.February, 12}:  NO_PICKUP_HOLIDAY,
	{2026, time.February, 13}:  TRASH,
	{2026, time.February, 16}:  NO_PICKUP_HOLIDAY,
	{2026, time.February, 17}:  TRASH,
	{2026, time.February, 18}:  NO_PICKUP,
	{2026, time.February, 19}:  COMMINGLES,
	{2026, time.February, 20}:  TRASH,
	{2026, time.February, 25}:  PAPER,
	{2026, time.March, 4}:      COMMINGLES,
	{2026, time.March, 11}:     PAPER,
	{2026, time.March, 18}:     COMMINGLES,
	{2026, time.March, 25}:     PAPER,
	{2026, time.April, 1}:      COMMINGLES,
	{2026, time.April, 8}:      PAPER,
	{2026, time.April, 15}:     COMMINGLES,
	{2026, time.April, 22}:     PAPER,
	{2026, time.April, 29}:     COMMINGLES,
	{2026, time.May, 6}:        PAPER,
	{2026, time.May, 13}:       COMMINGLES,
	{2026, time.May, 20}:       PAPER,
	{2026, time.May, 25}:       NO_PICKUP_HOLIDAY,
	{2026, time.May, 26}:       TRASH,
	{2026, time.May, 27}:       NO_PICKUP,
	{2026, time.May, 28}:       COMMINGLES,
	{2026, time.May, 29}:       TRASH,
	{2026, time.June, 3}:       PAPER,
	{2026, time.June, 10}:      COMMINGLES,
	{2026, time.June, 17}:      PAPER,
	{2026, time.June, 19}:      NO_PICKUP_HOLIDAY,
	{2026, time.June, 24}:      COMMINGLES,
	{2026, time.July, 1}:       PAPER,
	{2026, time.July, 3}:       NO_PICKUP_HOLIDAY,
	{2026, time.July, 8}:       COMMINGLES,
	{2026, time.July, 15}:      PAPER,
	{2026, time.July, 22}:      COMMINGLES,
	{2026, time.July, 29}:      PAPER,
	{2026, time.August, 5}:     COMMINGLES,
	{2026, time.August, 12}:    PAPER,
	{2026, time.August, 19}:    COMMINGLES,
	{2026, time.August, 26}:    PAPER,
	{2026, time.September, 2}:  COMMINGLES,
	{2026, time.September, 7}:  NO_PICKUP_HOLIDAY,
	{2026, time.September, 8}:  TRASH,
	{2026, time.September, 9}:  NO_PICKUP,
	{2026, time.September, 10}: PAPER,
	{2026, time.September, 11}: TRASH,
	{2026, time.September, 16}: COMMINGLES,
	{2026, time.September, 23}: PAPER,
	{2026, time.September, 30}: COMMINGLES,
	{2026, time.October, 7}:    COMMINGLES,
	{2026, time.October, 12}:   NO_PICKUP_HOLIDAY,
	{2026, time.October, 13}:   TRASH,
	{2026, time.October, 14}:   NO_PICKUP,
	{2026, time.October, 15}:   PAPER,
	{2026, time.October, 16}:   TRASH,
	{2026, time.October, 21}:   COMMINGLES,
	{2026, time.October, 28}:   PAPER,
	{2026, time.November, 3}:   NO_PICKUP_HOLIDAY,
	{2026, time.November, 4}:   NO_PICKUP,
	{2026, time.November, 5}:   COMMINGLES,
	{2026, time.November, 6}:   TRASH,
	{2026, time.November, 11}:  NO_PICKUP_HOLIDAY,
	{2026, time.November, 12}:  PAPER,
	{2026, time.November, 13}:  TRASH,
	{2026, time.November, 18}:  COMMINGLES,
	{2026, time.November, 25}:  PAPER,
	{2026, time.November, 26}:  NO_PICKUP_HOLIDAY,
	{2026, time.November, 27}:  TRASH,
	{2026, time.December, 2}:   COMMINGLES,
	{2026, time.December, 9}:   PAPER,
	{2026, time.December, 16}:  COMMINGLES,
	{2026, time.December, 23}:  PAPER,
	{2026, time.December, 25}:  NO_PICKUP_HOLIDAY,
	{2026, time.December, 30}:  COMMINGLES,
