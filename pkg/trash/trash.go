...
var special = map[simpleTime]Pickup{
	...
	{2023, time.January, 1}: NO_PICKUP_HOLIDAY,
	{2023, time.January, 5}: PAPER,
	{2023, time.January, 12}: COMMINGLES,
	{2023, time.January, 17}: NO_PICKUP_HOLIDAY,
	{2023, time.January, 18}: TRASH,
	{2023, time.January, 20}: PAPER,
	{2023, time.January, 21}: TRASH,
	{2023, time.January, 26}: COMMINGLES,
	{2023, time.February, 2}: PAPER,
	{2023, time.February, 9}: COMMINGLES,
	{2023, time.February, 16}: PAPER,
	{2023, time.February, 21}: NO_PICKUP_HOLIDAY,
	{2023, time.February, 22}: TRASH,
	{2023, time.February, 23}: NO_PICKUP_HOLIDAY,
	{2023, time.February, 24}: COMMINGLES,
	{2023, time.February, 25}: TRASH,
	{2023, time.March, 2}: PAPER,
	{2023, time.March, 9}: COMMINGLES,
	{2023, time.March, 16}: PAPER,
	{2023, time.March, 23}: COMMINGLES,
	{2023, time.March, 30}: PAPER,
	{2023, time.April, 6}: COMMINGLES,
	{2023, time.April, 13}: PAPER,
	{2023, time.April, 20}: COMMINGLES,
	{2023, time.April, 27}: PAPER,
	{2023, time.May, 4}: COMMINGLES,
	{2023, time.May, 11}: PAPER,
	{2023, time.May, 18}: COMMINGLES,
	{2023, time.May, 25}: PAPER,
	{2023, time.May, 30}: NO_PICKUP_HOLIDAY,
	{2023, time.May, 31}: TRASH,
	{2023, time.June, 1}: NO_PICKUP_HOLIDAY,
	{2023, time.June, 2}: COMMINGLES,
	{2023, time.June, 3}: TRASH,
	{2023, time.July, 4}: NO_PICKUP_HOLIDAY,
	{2023, time.July, 5}: TRASH,
	{2023, time.July, 6}: NO_PICKUP_HOLIDAY,
	{2023, time.July, 7}: PAPER,
	{2023, time.July, 8}: TRASH,
	{2023, time.July, 13}: COMMINGLES,
	{2023, time.July, 20}: PAPER,
	{2023, time.July, 27}: COMMINGLES,
	{2023, time.August, 3}: PAPER,
	{2023, time.August, 10}: COMMINGLES,
	{2023, time.August, 17}: PAPER,
	{2023, time.August, 24}: COMMINGLES,
	{2023, time.September, 5}: NO_PICKUP_HOLIDAY,
	{2023, time.September, 6}: TRASH,
	{2023, time.September, 7}: NO_PICKUP_HOLIDAY,
	{2023, time.September, 8}: COMMINGLES,
	{2023, time.September, 9}: TRASH,
	{2023, time.September, 14}: PAPER,
	{2023, time.September, 21}: COMMINGLES,
	{2023, time.September, 28}: PAPER,
	{2023, time.October, 5}: COMMINGLES,
	{2023, time.October, 10}: NO_PICKUP_HOLIDAY,
	{2023, time.October, 11}: TRASH,
	{2023, time.October, 12}: NO_PICKUP_HOLIDAY,
	{2023, time.October, 13}: PAPER,
	{2023, time.October, 14}: TRASH,
	{2023, time.November, 2}: COMMINGLES,
	{2023, time.November, 9}: PAPER,
	{2023, time.November, 11}: NO_PICKUP_HOLIDAY,
	{2023, time.November, 16}: COMMINGLES,
	{2023, time.November, 23}: PAPER,
	{2023, time.November, 24}: NO_PICKUP_HOLIDAY,
	{2023, time.November, 25}: TRASH,
	{2023, time.November, 30}: COMMINGLES,
	{2023, time.December, 7}: PAPER,
	{2023, time.December, 14}: COMMINGLES,
	{2023, time.December, 21}: PAPER,
	{2023, time.December, 26}: NO_PICKUP_HOLIDAY,
	{2023, time.December, 27}: TRASH,
	{2023, time.December, 28}: NO_PICKUP_HOLIDAY,
	{2023, time.December, 29}: COMMINGLES,
	{2023, time.December, 30}: TRASH,
}
